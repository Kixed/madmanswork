...
import io.swagger.client.model.ChargingFacilityDTO;
 ...
 * Metadata for Evse
 */
@ApiModel(description = "Metadata for Evse")
...
public class EvseDataDto {
  ...
  private List<ChargingFacilityDTO> chargingFacilities = null;
  ...
  public EvseDataDto versionedData(VersionedData versionedData) {
  ...
  **/
  ...
  public EvseDataDto chargingModes(List<ChargingModesEnum> chargingModes) {
    this.chargingModes = chargingModes;
    return this;
  }

  public EvseDataDto addChargingModesItem(ChargingModesEnum chargingModesItem) {
  ...
  **/
  @ApiModelProperty(value = "List of charging modes that are supported")
  ...
  public EvseDataDto plugTypes(List<PlugTypesEnum> plugTypes) {
    this.plugTypes = plugTypes;
    return this;
  }

  public EvseDataDto addPlugTypesItem(PlugTypesEnum plugTypesItem) {
   ...
   * @return plugTypes
  **/
  @ApiModelProperty(value = "List of plugs that are supported")
  ...
  public EvseDataDto chargingFacilities(List<ChargingFacilityDTO> chargingFacilities) {
    this.chargingFacilities = chargingFacilities;
    return this;
  }

  public EvseDataDto addChargingFacilitiesItem(ChargingFacilityDTO chargingFacilitiesItem) {
    if (this.chargingFacilities == null) {
      this.chargingFacilities = new ArrayList<ChargingFacilityDTO>();
    }
  ...
  **/
  @ApiModelProperty(value = "List of facilities that are supported")
  public List<ChargingFacilityDTO> getChargingFacilities() {
    return chargingFacilities;
  }

  public void setChargingFacilities(List<ChargingFacilityDTO> chargingFacilities) {
    this.chargingFacilities = chargingFacilities;
  }

  public EvseDataDto maxCapacity(Integer maxCapacity) {
   ...
   * @return maxCapacity
  **/
  @ApiModelProperty(value = "Maximum capacity in kWh.")
  ...
  public EvseDataDto changedOn(OffsetDateTime changedOn) {
  ...
  **/
  ...
  public EvseDataDto createdOn(OffsetDateTime createdOn) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.versionedData, evseDataDto.versionedData) &&
        Objects.equals(this.chargingModes, evseDataDto.chargingModes) &&
        Objects.equals(this.plugTypes, evseDataDto.plugTypes) &&
        Objects.equals(this.chargingFacilities, evseDataDto.chargingFacilities) &&
        Objects.equals(this.maxCapacity, evseDataDto.maxCapacity) &&
        Objects.equals(this.changedOn, evseDataDto.changedOn) &&
        Objects.equals(this.createdOn, evseDataDto.createdOn);
  }
