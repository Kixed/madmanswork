...
import io.swagger.client.model.RemoteChargingFacilityDTO;
...
public class RemoteEvseDataDTO {
  ...
  private List<RemoteChargingFacilityDTO> chargingFacilities = null;
  ...
  public RemoteEvseDataDTO versionedData(VersionedData versionedData) {
  ...
  **/
  ...
  public RemoteEvseDataDTO chargingModes(List<ChargingModesEnum> chargingModes) {
    this.chargingModes = chargingModes;
    return this;
  }

  public RemoteEvseDataDTO addChargingModesItem(ChargingModesEnum chargingModesItem) {
  ...
  **/
  ...
  public RemoteEvseDataDTO plugTypes(List<PlugTypesEnum> plugTypes) {
    this.plugTypes = plugTypes;
    return this;
  }

  public RemoteEvseDataDTO addPlugTypesItem(PlugTypesEnum plugTypesItem) {
  ...
  **/
  ...
  public RemoteEvseDataDTO chargingFacilities(List<RemoteChargingFacilityDTO> chargingFacilities) {
    this.chargingFacilities = chargingFacilities;
    return this;
  }

  public RemoteEvseDataDTO addChargingFacilitiesItem(RemoteChargingFacilityDTO chargingFacilitiesItem) {
    if (this.chargingFacilities == null) {
      this.chargingFacilities = new ArrayList<RemoteChargingFacilityDTO>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<RemoteChargingFacilityDTO> getChargingFacilities() {
    return chargingFacilities;
  }

  public void setChargingFacilities(List<RemoteChargingFacilityDTO> chargingFacilities) {
    this.chargingFacilities = chargingFacilities;
  }

  public RemoteEvseDataDTO maxCapacity(Integer maxCapacity) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RemoteEvseDataDTO remoteEvseDataDTO = (RemoteEvseDataDTO) o;
    return Objects.equals(this.versionedData, remoteEvseDataDTO.versionedData) &&
        Objects.equals(this.chargingModes, remoteEvseDataDTO.chargingModes) &&
        Objects.equals(this.plugTypes, remoteEvseDataDTO.plugTypes) &&
        Objects.equals(this.chargingFacilities, remoteEvseDataDTO.chargingFacilities) &&
        Objects.equals(this.maxCapacity, remoteEvseDataDTO.maxCapacity) &&
        Objects.equals(this.changedOn, remoteEvseDataDTO.changedOn) &&
        Objects.equals(this.createdOn, remoteEvseDataDTO.createdOn);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoteEvseDataDTO {\n");
