...
import io.swagger.client.model.RemoteChargingFacilityListDTO;
...
public class RemoteEvseDataListDTO {
  ...
  private List<RemoteChargingFacilityListDTO> chargingFacilities = null;
  ...
  public RemoteEvseDataListDTO id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public RemoteEvseDataListDTO chargingModes(List<ChargingModesEnum> chargingModes) {
    this.chargingModes = chargingModes;
    return this;
  }

  public RemoteEvseDataListDTO addChargingModesItem(ChargingModesEnum chargingModesItem) {
  ...
  **/
  ...
  public RemoteEvseDataListDTO plugTypes(List<PlugTypesEnum> plugTypes) {
    this.plugTypes = plugTypes;
    return this;
  }

  public RemoteEvseDataListDTO addPlugTypesItem(PlugTypesEnum plugTypesItem) {
  ...
  **/
  ...
  public RemoteEvseDataListDTO chargingFacilities(List<RemoteChargingFacilityListDTO> chargingFacilities) {
    this.chargingFacilities = chargingFacilities;
    return this;
  }

  public RemoteEvseDataListDTO addChargingFacilitiesItem(RemoteChargingFacilityListDTO chargingFacilitiesItem) {
    if (this.chargingFacilities == null) {
      this.chargingFacilities = new ArrayList<RemoteChargingFacilityListDTO>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<RemoteChargingFacilityListDTO> getChargingFacilities() {
    return chargingFacilities;
  }

  public void setChargingFacilities(List<RemoteChargingFacilityListDTO> chargingFacilities) {
    this.chargingFacilities = chargingFacilities;
  }

  public RemoteEvseDataListDTO maxCapacity(Integer maxCapacity) {
  ...
  **/
  ...
  public RemoteEvseDataListDTO createdOn(OffsetDateTime createdOn) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RemoteEvseDataListDTO remoteEvseDataListDTO = (RemoteEvseDataListDTO) o;
    return Objects.equals(this.id, remoteEvseDataListDTO.id) &&
        Objects.equals(this.chargingModes, remoteEvseDataListDTO.chargingModes) &&
        Objects.equals(this.plugTypes, remoteEvseDataListDTO.plugTypes) &&
        Objects.equals(this.chargingFacilities, remoteEvseDataListDTO.chargingFacilities) &&
        Objects.equals(this.maxCapacity, remoteEvseDataListDTO.maxCapacity) &&
        Objects.equals(this.createdOn, remoteEvseDataListDTO.createdOn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, chargingModes, plugTypes, chargingFacilities, maxCapacity, createdOn);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoteEvseDataListDTO {\n");
